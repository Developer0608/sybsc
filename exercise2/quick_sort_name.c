...
int quick(struct employee *emp , int lower_bound , int upper_bound)
{
  ...
  if (lower_bound < upper_bound)
  {
      ...
      while(i < j)
      {
        while(strcmp(emp[i].Firstname ,emp[pivot].Firstname) <= strcmp(emp[pivot].Firstname ,emp[i].Firstname) && i < j)
        {
          i++;
        }

        while(strcmp(emp[j].Firstname , emp[pivot].Firstname) > strcmp(emp[pivot].Firstname,emp[j].Firstname))
        {
          j--;
        }
